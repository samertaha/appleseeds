...
console.log(
  'carMarket.getAgencyIdByName(Best Deal):',
  carMarket.getAgencyIdByName('Best Deal')
);
...
carMarket.getAllAgenciesName = function () {
  return this.sellers.map((agency) => agency.agencyName);
};

console.log('carMarket.getAllAgenciesName:', carMarket.getAllAgenciesName());
...
carMarket.getAllCarToBuy = function () {
  ...
  this.sellers.forEach((agency) =>
    agency.cars.forEach((car) =>
      car.models.forEach((model) => cars.push(model))
    )
  );
  return cars;
};

console.log('getAllCarToBuy:', carMarket.getAllCarToBuy());
console.log('---------------------------------------');
...
carMarket.getAllCarToBuyByAgencyId = function (id) {
  let cars = [];
  const agency = this.sellers.find((agency) => agency.agencyId == id);
...
carMarket.getAllBrandsToBuyAgencyId = function (id) {
  ...
  agency.cars.forEach((car) => brands.push(car.brand));
  return brands;
};

console.log(
  'getAllBrandsToBuyAgencyId(Plyq5M5AZ):',
  carMarket.getAllBrandsToBuyAgencyId('Plyq5M5AZ')
);
...
console.log(
  'carMarket.getCustomerByName(Lilah Goulding):',
  carMarket.getCustomerByName('Lilah Goulding')
);
console.log('---------------------------------------');
//* getCustomerIdByName
...
carMarket.getCustomerIdByName = function (name) {
  return this.customers.find((customer) => customer.name == name).id;
};

console.log(
  'carMarket.getCustomerIdByName(Lilah Goulding):',
  carMarket.getCustomerIdByName('Lilah Goulding')
);
console.log('---------------------------------------');
...
carMarket.getAllCustomerCars = function (costumerId) {
  customerCars = [];
  const customer = this.customers.find((customer) => customer.id == costumerId);
  customer.cars.forEach((car) => customerCars.push(car));

  return customerCars;
};
console.log(
  'carMarket.getAllCustomerCars(BGzHhjnE8):',
  carMarket.getAllCustomerCars('BGzHhjnE8')
);
console.log('---------------------------------------');
//* getCustomerCash
...
carMarket.getCustomerCash = function (costumerId) {
  return this.customers.find((customer) => customer.id == costumerId).cash;
};

console.log(
  'carMarket.getCustomerCash(BGzHhjnE8):',
  carMarket.getCustomerCash('BGzHhjnE8')
);
console.log('---------------------------------------');
...
console.log('new car with carNumber = AKDJSJF was added to agency Plyq5M5AZ');
console.log(
  'carMarket.getAllCarToBuyByAgencyId(Plyq5M5AZ):',
  carMarket.getAllCarToBuyByAgencyId('Plyq5M5AZ')
);
...
carMarket.deleteCarFromAgency = function (agencyId, carId) {
  let agency = this.sellers.find((agency) => agency.agencyId == agencyId);
  agency.cars.forEach((car) => {
    car.models = car.models.filter((m) => m.carNumber !== carId);
  });
};
carMarket.deleteCarFromAgency('Plyq5M5AZ', 'AKDJSJF');
console.log('deleted car AKDJSJF from agency Plyq5M5AZ');
console.log(
  'carMarket.getAllCarToBuyByAgencyId(Plyq5M5AZ):',
  carMarket.getAllCarToBuyByAgencyId('Plyq5M5AZ')
);
...
carMarket.decrementOrIncrementCashOfAgency = function (agencyId, amount) {
  return (this.sellers.find((agency) => agency.agencyId == agencyId).cash +=
    amount);
};
console.log(
  'carMarket.decrementOrIncrementCashOfAgency(Plyq5M5AZ, 1000)',
  carMarket.decrementOrIncrementCashOfAgency('Plyq5M5AZ', 1000)
);
console.log('---------------------------------------');
...
carMarket.decrementOrIncrementCreditOfAgency = function (agencyId, amount) {
  return (this.sellers.find((agency) => agency.agencyId == agencyId).credit +=
    amount);
};

console.log(
  'carMarket.decrementOrIncrementCreditOfAgency(Plyq5M5AZ, 1000)',
  carMarket.decrementOrIncrementCreditOfAgency('Plyq5M5AZ', 100000)
);
console.log('---------------------------------------');
...
carMarket.setAmountOfCarsToBuyToAllAgencys = function () {
  let sum = 0;
  this.sellers.forEach((agency) => {
    agency.cars.forEach((car) => (sum += car.models.length));
...
carMarket.setCarToCostumer = function (costumerId, carObject) {
  let customer = this.customers.find((customer) => customer.id == costumerId);
  customer.cars.push({ ...carObject, ownerId: costumerId });
  return customer.cars;
};
console.log(
  'carMarket.setCarToCostumer(BGzHhjnE8,{name:sosita}...',
...
carMarket.deleteCarOfCostumer = function (customerId, carId) {
  ...
  customer.cars = customer.cars.filter((car) => car.carNumber !== carId);
  return customer.cars;
};

console.log(
  'carMarket.deleteCarOfCostumer(BGzHhjnE8,GGGGGG):',
  carMarket.deleteCarOfCostumer('BGzHhjnE8', 'GGGGGG')
);
...
console.log(
  'carMarket.decrementOrIncrementCashOfCostumer(BGzHhjnE8, 35000):',
  carMarket.decrementOrIncrementCashOfCostumer('BGzHhjnE8', 35000)
);
console.log('---------------------------------------');
...
const cars = carMarket.sortAndFilterByYearOfProduction(
  carMarket.getAllCarToBuyByAgencyId('Plyq5M5AZ'),
  2005,
  2015,
  false
...
console.log(
  'carMarket.sortAndFilterByYearOfProduction agency cars Best Deal:',
  cars
);
